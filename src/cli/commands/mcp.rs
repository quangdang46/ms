...
fn run_tcp_server(mut ctx: AppContext, port: u16, debug: bool) -> Result<()> {
...
fn maybe_reopen_stores(ctx: &mut AppContext, opened: &mut crate::app::StoreIdentity, debug: bool) {
